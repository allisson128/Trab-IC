...
def main():
    ...
    candidatosSize = 300 #Populcao de solucoes candidatas
    mutRate = 0.01 #percentual de vezes  que ocorre mutacao, em cima de candidatosSize
    grupoSize = 10
    ...
    #                                                      #
    ########################################################
    #   A var. 'candidatosSize' indica a qtd de solucoes   #
    ...
    for i in range(0,candidatosSize):
    ...
    for it in range(0,100000): #Limite de 20 iteracoes
        ...
        #                                                       #
        #########################################################
        for i in range(0,int(mutRate*candidatosSize)):
            randA = random.randint(0, candidatosSize-1)
